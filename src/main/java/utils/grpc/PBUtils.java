...
import marmot.proto.Int32Proto;
import marmot.proto.Int32Response;
import marmot.proto.Int64Proto;
...
public class PBUtils {
	...
	public static Int32Proto INT32(int value) {
		return Int32Proto.newBuilder().setValue(value).build();
	}
	public static int handle(Int32Response resp) {
		switch ( resp.getEitherCase() ) {
			case VALUE:
	...
	public static long handle(Int64Response resp) {
		switch ( resp.getEitherCase() ) {
			case VALUE:
				return resp.getValue();
			case ERROR:
